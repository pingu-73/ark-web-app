...
use ark_client::{error::Error as ArkError, wallet::Persistence, Client, OfflineClient};
...
impl AppState {
    ...
    pub async fn recalculate_balance(&self) -> Result<()> {
        ...
        *balance = crate::models::wallet::WalletBalance {
        ...
        self.db_manager
            .save_setting("balance", &balance_json)
            .await?;
...
impl std::ops::Deref for AppStateRef {
    ...
    fn deref(&self) -> &Self::Target {
        ...
        APP_STATE_CELL
            .get()
            .expect("APP_STATE not initialized - call initialize_app_state() first")
    }
}
